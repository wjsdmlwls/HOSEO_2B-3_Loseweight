				            ...
				            <div class="signin-cont cont">
					                <form action="loginAction.jsp" method="post">
						                    ...
						                    <div class="submit-wrap">
							                        ...
							                        <a href="#" class="more">아이디 비밀번호찾기 </a>
						                    </div>
        					        </form>
    				        </div>
    				        
    	 	<div class="signup-cont cont">
    			<form action="user_signUp.jsp" method="post" enctype="multipart/form-data">
                    <input type="text" name="lw_id" id="lw_id" class="inpt" required="required" placeholder="아이디">
                    <label for="lw_id">아이디</label>
                    <input type="password" name="lw_passwd" id="lw_passwd" class="inpt" required="required" placeholder="비밀번호">
                    <input type="password" name="lw_passwd2" id="lw_passwd2" class="inpt" required="required" placeholder="비밀번호 확인">
   						    <label for="lw_passwd">비밀번호</label>
   						    <input type="text" name="lw_name" id="lw_name" class="inpt" required="required" placeholder="이름">
                    <label for="lw_name">이름</label>
   						    <input type="text" name="email1" id="email1" class="inpte" required="required" placeholder="이메일"> @ 
   						    <input name="email2" id="email2" class="inpte" required="required" placeholder="이메일2">
   						    <select>
   						    	<option value="google">google.com</option>
   						    	<option value="naver">naver.com</option>
   						    	<option value="nate">nate.com</option>
   						    	<option value="daum">hanmail.com</option>
   						    	<option value="naver">naver.com</option	>
   						    </select>
                    <label for="name">이메일</label>
             							<input type="text" name="zipcode" id="zipcode" class="inpt" required="required" placeholder="우편번호">
                    <input type="text" name="add" id="add" class="inpt" required="required" placeholder="주소">
             							<input type="text" name="add2" id="add2" class="inpt" required="required" placeholder="상세주소를 입력해주세요">
                    <label for="email">주소</label>
             							<input type="text" name="email" id="email" class="inpt" required="required" placeholder="전화번호">
