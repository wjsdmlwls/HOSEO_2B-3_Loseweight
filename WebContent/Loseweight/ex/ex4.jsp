...
.text1 {
	font-family: "segoe ui", "malgun gothic", "microsoft neogothic",
...
.bluefont {
	color: #0075d5;
	font-family: "segoe ui", "malgun gothic bold", "malgun gothic",
		"microsoft neogothic bold", applegothic, sans-serif;
	font-size: 16px;
	line-height: 1.733;
	...
	<div class="main">
		...
		<div class="box">
			<div class="textleft">
				...
				<p class="blackfont_link_p">
					<a class="blackfont_link" href="ex1.jsp">푸시업</a>
				</p>
				<p class="blackfont_link_p">
					<a class="blackfont_link" href="ex5.jsp. jsp">푸쉬업 - 메디슨볼,클로즈 그립</a>
				</p>
			</div>
			<div class="videos">
				<iframe
					src="https://prod-video-cms-amp-microsoft-com.akamaized.net/tenant/amp/entityid/AATG4r?blobrefkey=103&$blob=1"
		...
		<div class="box2">
			...
			<div class="img">
				<img class="img1" src="eximg/한쪽팔 푸쉬업-메디슨1.jpg" alt="dd">
				<p class="img_text_1">1단계</p>
				<p class="img_text_2">한 손은 가슴 바로 아래 메디슨 볼에 올리고 다른 손은 허리 뒤에 올리며
					팔굽혀펴기 자세를 시작합니다. 뒤에 있는 다리는 곧게 펴고 발 끝이 지면을 향하도록 하여 넓게 벌립니다.</p>
			</div>

			<div class="img">
				<img class="img1" src="eximg/한쪽팔 푸쉬업-메디슨2.jpg" alt="dd">
				<p class="img_text_1">2단계</p>
				<p class="img_text_2">가슴이 거의 공에 닿을 때까지 몸을 낮추고, 이때 팔꿈치는 상체 옆쪽으로
					밀착시키도록 합니다. 잠시 멈췄다가 다시 팔을 펴서 처음 자세로 돌아옵니다.</p>
			</div>
		</div>
		...
		<div class="box3">
			...
			<div class="next_imgs">
				<div class="next_imgs_div">
					<a class="next_img_a" href="ex.jsp"> <img class="next_img"
						src="eximg/푸쉬업_1단계.jpg">
				...
				<div class="next_imgs_div">
					<a class="next_img_a" href="ex2.jsp"> <img class="next_img"
						src="eximg/무릎을 꿇은 자세.jpg">
			...
			<div class="next_imgs">
				<div class="next_imgs_div">
					<a class="next_img_a" href="ex3.jsp"> <img class="next_img"
						src="eximg/메디슨볼.jpg">
				...
				<div class="next_imgs_div">
					<a class="next_img_a" href="ex5.jsp"> <img class="next_img"
						src="eximg/클로즈그립1.jpg">
			...
			<div class="next_imgs">
				<div class="next_imgs_div">
					<a class="next_img_a" href="ex6.jsp"> <img class="next_img"
						src="eximg/한쪽팔푸쉬업.jpg">
