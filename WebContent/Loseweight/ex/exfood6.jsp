...
<div class="box">
<div class="textleft">
<p class="text1">성인의 기본 식단</p>
<p class="bluefont">초점</p>
<p class="blackfont">성인 권장 식단</p>
<p class="bluefont">식단시 주의 사항</p>
<p class="blackfont">-성인 남성의 평균 필요에너지량은 1일 2400kcal다. 곡류를 성장기보다 많이 먹어야 한다.</p>
<p class="blackfont">-성인 여성의 평균 필요에너지량은 1일 1900kcal다. 청소년기에 비해 유제품류는 적게, 채소류는 더 많이 먹으면 된다.</p>
<p class="bluefont">이런식단은 피해라</p>
<p class="blackfont">-성인 남성은 김치찌개, 된장찌개 등 고나트륨 함유 식품 섭취율이 높다. 저나트륨 김치를 먹거나,
 김치는 하루에 1회 정도로 제한하고 찌개 대신 국으로 대체하는 게 좋다.</p>
 <p class="blackfont">-성인 여성 역시 성인 남성과 비슷하게 김치, 찌개류, 장류 섭취가 많다.
  김치는 1일 1회만 먹고, 김치가 없는 끼니는 오이소박이나 배추겉절이, 샐러드 등으로 대체하면 좋다.</p>

<p class="bluefont_link">각 식단별 종류</p>
<p class="blackfont_link_p"><a class="blackfont_link" href="exfood2.jsp">주부 식단</a></p>
...
<div class="videos">
<img src="ex_img/exfood6.jpg">
<img src="ex_img/exfood6_1.jpg">
		</div>
