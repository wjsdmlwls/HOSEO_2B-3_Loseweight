...
<div class="videos">
<iframe src="https://prod-video-cms-amp-microsoft-com.akamaized.net/tenant/amp/entityid/AATD3m?blobrefkey=103&$blob=1" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
		</div>
...
<div class="img">
<img class="img1" src="eximg/랫풀다운1.jpg" alt="dd">
<p class="img_text_1">1단계</p>
<p class="img_text_2">
랫 풀다운 스테이션에 앉은 상태에서 양팔을 어깨 높이보다 약간 넓게 놓고 오버핸드 그립으로 바를 잡습니다. 
양팔은 완전히 일직선이 되어야 하고 상체를 곧게 세워야 합니다.</p>
</div>

<div class="img">
<img class="img1" src="eximg/랫풀다운2.jpg" alt="dd">
<p class="img_text_1">2단계</p>
<p class="img_text_2">
견갑골은 뒷쪽 아래 방향으로 당기고 바를 가슴쪽으로 당깁니다. 
잠시 정지한 후, 처음 자세로 천천히 돌아옵니다.</p>
</div>
</div>
...
<p class="next_img_text1">쿼터 스쿼트-바벨</p>
