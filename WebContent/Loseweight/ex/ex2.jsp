...
<div class="videos">
<iframe src="https://prod-video-cms-amp-microsoft-com.akamaized.net/tenant/amp/entityid/AATCI7?blobrefkey=103&$blob=1" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
		</div>
...
<div class="img">
<img class="img1" src="eximg/무릎1.jpg" alt="dd">
<p class="img_text_1">1단계</p>
<p class="img_text_2">
무릎을 꿇고 양손을 어깨와 일직선이 되도록 바닥에 내려놓고 손을 어깨너비보다 조금 넓게 벌립니다. 
코어를 수축하면서 무릎에서 어깨까지 일직선이 되도록 두 다리를 곧게 폅니다.</p>
</div>

<div class="img">
<img class="img1" src="eximg/무릎2.jpg" alt="dd">
<p class="img_text_1">2단계</p>
<p class="img_text_2">
양쪽 팔꿈치는 상체 옆에 붙이고 가슴이 거의 바닥에 닿을 때까지 팔꿈치를 굽혀 몸을 낮춥니다.</p>
</div>

<div class="img">
<img class="img1" src="eximg/무릎3.jpg" alt="dd">
<p class="img_text_1">2단계</p>
<p class="img_text_2">
잠시 멈췄다가 몸을 밀어 시작 위치로 돌아옵니다.</p>
</div>
</div>
