...
<div class="box">
<div class="textleft">
<p class="text1">고단백&저지방 식단</p>
<p class="bluefont">초점</p>
<p class="blackfont">체중감량이 필요하다면 지켜야할 필수 다이어트 식단</p>
<p class="bluefont">메뉴</p>
<p class="blackfont">아침: 닭가슴살야채볶음밥, 양배추토마토샐러드, 사과</p>
<p class="blackfont">점심: 현미밥, 닭가슴살샐러드, 백김치, 단호박찜</p>
<p class="blackfont">저녁: 콩밥, 미역국</p>
