...
<div class="box">
<div class="textleft">
<p class="text1">청소년 권장 아침식사(12~18세)</p>
<p class="bluefont">초점</p>
<p class="blackfont">청소년기 최소 권장 식단</p>
<p class="bluefont">이런식단은 피해라</p>
<p class="blackfont">라면은 청소년 남성이 즐겨먹는데 고염·고지방이라 균형적인 식생활을 저해한다.</p>
<p class="blackfont">청소년 여성은 초콜릿·사탕 등 단순당 함량이 높은 간식을 많이 먹는 경향이 있어 단순당 식품은 식생활을 저해한다.</p>

<p class="bluefont_link">각 식단별 종류</p>
<p class="blackfont_link_p"><a class="blackfont_link" href="exfood.jsp">하루기본의 식단</a></p>
...
<div class="videos">
<img src="ex_img/exfood5.jpg">
<img src="ex_img/exfood5_1.jpg">
		</div>
