...
<div class="box">
<div class="textleft">
<p class="text1">하루 기본의 식단</p>
<p class="bluefont">초점</p>
<p class="blackfont">여성들이 하기에 좋은 다이어트 식단</p>
<p class="bluefont">메뉴</p>
<p class="blackfont">아침: 식빵, 저지방우유, 달걀, 양배추샐러드, 자몽</p>
<p class="blackfont">점심: 잡곡밥, 된장국, 삼치구이, 콩나물, 배추김치</p>
