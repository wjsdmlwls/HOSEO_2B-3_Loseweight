...
<body>
	...
	<div class="row">
		<div class="column">
			<div class="column1">
				<div id="exercise-summary" class="exercise-section">
					...
					<div id="metadata">
						...
						<div class="exercise-metadata">
							<h4>※초점</h4>
							<p>여성들이 하기에 좋은 다이어트 식단</p>
						</div>


						<div class="exercise-metadata">
							<h4>※메뉴</h4>
							<p>아침: 식빵, 저지방우유, 달걀, 양배추샐러드, 자몽</p>
							<p>점심: 잡곡밥, 된장국, 삼치구이, 콩나물, 배추김치</p>
							<p>저녁: 콩밥, 미역국</p>
						</div>
						<hr>
						<div>
			...
			<div class="column2">
				<img src="ex_img/exfood.jpg" alt="식단" width="800px" height="600px">
			</div>
		</div>
		<div class="column">
			<div class="exD">
				<div id="step-1" class="slide-view">
					<img alt="주의 사항"
						src="ex_img/ex_Pre.png"	class="ex_Pre">
