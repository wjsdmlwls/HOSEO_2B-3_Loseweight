...
<body>
	...
	<div class="row">
		<div class="column">
			<div class="column1">
				<div id="exercise-summary" class="exercise-section">
					...
					<div id="metadata">
						...
						<div class="exercise-metadata">
							<h4>※초점</h4>
							<p>-비교적 자유롭고 활동량이 적은 주부들을 위한 식단</p>
						</div>


						<div class="exercise-metadata">
							<h4>※메뉴</h4>
							<p>아침: 계란스크램블, 사과, 저지방우유, 호두&아몬드</p>
							<p>점심: 일반식사</p>
							<p>저녁: 닭가슴살, 야채&과일, 저지방우유, 호두&아몬드</p>
						</div>
						<hr>
						<div>
							<h3>※각 식단별 종류</h3>
			...
			<div class="column2">
				<img src="ex_img/exfood2.jpg" alt="식단" width="800px" height="600px">
			</div>
		</div>
		<div class="column">
			<div class="exD">
