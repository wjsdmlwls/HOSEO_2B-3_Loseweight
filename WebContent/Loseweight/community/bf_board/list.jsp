...
<div class="div_body" >
	...
	<%if(listsearchresult.next()){
		...
		%>
			    <tr height="50" style="border-top: 1pt solid gray;cursor: pointer;" OnClick="location.href ='content.jsp?num=<%=num%>&pageNum=<%=currentPage%>'">
	...
	%><%if(id!=null||id!=""){%>
	<a href="writeForm.jsp"><input style="text-align: center;margin-top: -5px;float:right;" class="newbutton"value="글쓰기"></a>
	</div>
	<%} %>
