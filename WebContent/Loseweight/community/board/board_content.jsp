...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">  <script type="text/javascript" src="http://code.jquery.com/jquery-1.11.3.js"></script>
...
<body>
		...
		<div style='width: 100%;'>
			...
			<div class="div_sidecontents" >
				...
				<div style="margin:0 auto;margin-top:5%;width:1000px">			
								<a href='board_list.jsp' class="board_dir"style="font-weight:bold;text-decoration:none"></a>
				</div>
	...
	var form = document.createElement("form");
        ...
        form.setAttribute("action", "board_replyedit.jsp");
