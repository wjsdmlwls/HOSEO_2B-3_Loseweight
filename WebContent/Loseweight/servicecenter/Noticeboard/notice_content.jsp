...
<jsp:include page="../../community/community_topinclude.jsp" >
	...
	<div align="right">
						  ...
						  <input type="button" value="글삭제" class="all_button"
 					       onclick="document.location.href='notice_deleteForm.jsp?num=<%=article.getNum()%>&pageNum=<%=pageNum%>'">
						   &nbsp;&nbsp;
					      <input type="button" value="답글쓰기" class="all_button"
					       onclick="document.location.href='notice_writeForm.jsp?num=<%=num%>&ref=<%=ref%>&re_step=<%=re_step%>&re_level=<%=re_level%>'">
						   &nbsp;&nbsp;
